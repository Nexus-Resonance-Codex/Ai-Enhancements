...
4.  **"AI Applications"** refers to the use of NRC Materials in artificial intelligence, machine learning, proprietary enterprise models, cloud APIs, closed-source SaaS offerings, or for-profit autonomous systems.
...
Entities seeking to utilize the NRC Materials for Commercial Use—including but not limited to commercial AI APIs, proprietary model training pipelines, or for-profit software services—must negotiate a separate Commercial License Agreement.

Such agreements will be structured equitably to reflect standard industry practices, potentially including upfront licensing fees, deployment milestones, and fair royalty structures based on net sales or derivative value.
