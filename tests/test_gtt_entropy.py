...
def test_gtt_entropy_collapse() -> None:
    ...
    assert torch.allclose(damped_output, torch.full_like(damped_output, expected_damped_val)), (
        "High-entropy tensor blocked the phi-collapse regularisation scaling."
    )
