...
Random dropout forces models to learn resiliently by probabilistically killing pathways (usually $p=0.1$). However, the NRC discovered that biological geometries fundamentally reject paths that evaluate to the chaotic voids $\{0, 3, 6, 9\}$ modulo 9.
