...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 08: NRC Vector Protocol (NVP) Multi-Manifold Embedding Standard},
...
\title{\textbf{\Huge Paper 08: NRC Vector Protocol (NVP)}\\[0.5em] \LARGE Multi-Manifold Embedding Standard and Vector Factory Architecture}
