...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 18: Global Tensor Thermodynamics (GTT) Entropy Collapse Regularizer — Thermodynamic Sanity Bounds and Phi Noise Suppression},
...
\title{\textbf{\Huge Paper 18: Global Tensor Thermodynamics (GTT) Entropy Collapse Regularizer — Thermodynamic Sanity Bounds and Phi Noise Suppression}\\[0.5em] \LARGE Mid-Flight Shannon Entropy Monitoring, Thermodynamic Upper Bounds (H_{safe} = 10.96 nats), and Instantaneous Tensor Damping}
