...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 25: Nexus Resonance Codex — Navier Stokes Damping},
...
\title{\textbf{\Huge Paper 25: Nexus Resonance Codex — Navier Stokes Damping}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Navier Stokes Damping}
