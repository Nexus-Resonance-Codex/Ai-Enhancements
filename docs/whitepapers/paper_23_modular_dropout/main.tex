...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 23: Nexus Resonance Codex — Modular Dropout},
...
\title{\textbf{\Huge Paper 23: Nexus Resonance Codex — Modular Dropout}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Modular Dropout}
