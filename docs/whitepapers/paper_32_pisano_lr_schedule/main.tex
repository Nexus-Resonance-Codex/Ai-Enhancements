...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 32: Nexus Resonance Codex — Pisano Lr Schedule},
...
\title{\textbf{\Huge Paper 32: Nexus Resonance Codex — Pisano Lr Schedule}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Pisano Lr Schedule}
