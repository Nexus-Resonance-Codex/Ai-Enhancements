...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 24: Nexus Resonance Codex — Mst Lyapunov Clipping},
...
\title{\textbf{\Huge Paper 24: Nexus Resonance Codex — Mst Lyapunov Clipping}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Mst Lyapunov Clipping}
