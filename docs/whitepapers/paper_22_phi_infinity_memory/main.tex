...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 22: Nexus Resonance Codex — Phi Infinity Memory},
...
\title{\textbf{\Huge Paper 22: Nexus Resonance Codex — Phi Infinity Memory}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Phi Infinity Memory}
