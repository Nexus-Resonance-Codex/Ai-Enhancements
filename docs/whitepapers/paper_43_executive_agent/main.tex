...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 43: Nexus Resonance Codex — Executive Agent},
...
\title{\textbf{\Huge Paper 43: Nexus Resonance Codex — Executive Agent}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Executive Agent}
