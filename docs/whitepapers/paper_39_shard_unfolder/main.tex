...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 39: Infinite E-Infinity Context Shard Unfolding: Exact State Resolution Recovery},
	pdfauthor={James Paul Trageser},
	pdfsubject={Nexus Resonance Codex (NRC) Ai-Enhancements},
	pdfkeywords={Deep Learning, Context Unfolding, Infinite Context, Golden Ratio, Tensor Resolution}
}

\title{\textbf{\Huge Paper 39: Infinite $E_\infty$ Context Shard Unfolding}\\[0.5em] \LARGE Algebraic Inversion of Phase-Folded Memory Blocks for Ultra-Long Sequence Resolution}
