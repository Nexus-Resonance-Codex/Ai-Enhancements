...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 41: Nexus Resonance Codex — Tupt Sync Seed},
...
\title{\textbf{\Huge Paper 41: Nexus Resonance Codex — Tupt Sync Seed}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Tupt Sync Seed}
