...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Phi-Void Positional Encoding: A Novel Approach to Sequence Embeddings with Golden Ratio Geometry},
...
\title{\textbf{\Huge Phi-Void Positional Encoding: A Novel Approach to Sequence Embeddings with Golden Ratio Geometry}\\[0.5em] \LARGE Enhancing Neural Network Architectures with Native Phi^6 Void Resonance Positional Encoding for High-Dimensional Manifold Projections}
