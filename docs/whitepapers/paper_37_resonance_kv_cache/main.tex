...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 37: Resonance-Shard KV-Cache Architecture and Quantum Shadow Veil Encryption},
	pdfauthor={James Paul Trageser},
	pdfsubject={Nexus Resonance Codex (NRC) Ai-Enhancements},
	pdfkeywords={Deep Learning, KV-Cache, Memory Sharding, Quantum Shadow Veil, Golden Ratio}
}

\title{\textbf{\Huge Paper 37: Resonance-Shard KV-Cache Architecture}\\[0.5em] \LARGE Institutional-Grade Memory Sharding with Quantum Shadow Veil Encryption}
