...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 34: Nexus Resonance Codex — Qrt Attention Bias},
...
\title{\textbf{\Huge Paper 34: Nexus Resonance Codex — Qrt Attention Bias}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Qrt Attention Bias}
