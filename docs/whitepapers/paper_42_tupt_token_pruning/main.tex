...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 42: Nexus Resonance Codex — Tupt Token Pruning},
...
\title{\textbf{\Huge Paper 42: Nexus Resonance Codex — Tupt Token Pruning}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Tupt Token Pruning}
