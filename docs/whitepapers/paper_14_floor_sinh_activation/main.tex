...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 14: Nexus Resonance Codex — Floor-Sinh Transcendental Activations},
	pdfauthor={James Paul Trageser},
	pdfsubject={Nexus Resonance Codex (NRC) Ai-Enhancements},
	pdfkeywords={Deep Learning, Hyperbolic Sine, Activation Regularization, Physical Floor, TTT-7 Stability}
}

\title{\textbf{\Huge Paper 14: Floor-Sinh Transcendental Activations}\\[0.5em] \LARGE Hyperbolic Sine Geometries with Rigid Physical Floor Constraints for Dimension Collapse Prevention}
