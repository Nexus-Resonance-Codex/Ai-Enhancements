...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 21: Nexus Resonance Codex — Lucas Sparse Mask},
...
\title{\textbf{\Huge Paper 21: Nexus Resonance Codex — Lucas Sparse Mask}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Lucas Sparse Mask}
