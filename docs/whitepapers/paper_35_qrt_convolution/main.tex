...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 35: Nexus Resonance Codex — Qrt Convolution},
...
\title{\textbf{\Huge Paper 35: Nexus Resonance Codex — Qrt Convolution}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Qrt Convolution}
