...
\hypersetup{
	...
	citecolor=nrcgold,
	urlcolor=nrcblue,
	pdftitle={Paper 44: Nexus Resonance Codex — Huggingface Deployment},
...
\title{\textbf{\Huge Paper 44: Nexus Resonance Codex — Huggingface Deployment}\\[0.5em] \LARGE Formal Mathematical Foundations and Multi-Manifold Architecture for Huggingface Deployment}
